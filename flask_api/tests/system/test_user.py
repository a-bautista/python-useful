...
class UserTest(BaseTest):
    # Test the user registration - result should be User created successfully
        ...
        with self.app() as client:
            with self.app_context():
                ...
                auth_response = client.post('/auth',
                                           ...
                                           # this indicates the type of data you are sending
                                           header = {'Content-Type': 'application/json'})

                # check if the access token is in the list
